  ...
  v-app(dark)
    v-navigation-drawer(
      ...
      v-card.text-xs-center.pb-3
        ...
        iframe(src="https://view.adex.network?width=300&height=250&slotId=5bf2fa911b1d40001c55541f&slotIpfs=QmYbkwHHzWhPK4K5kfgP9yYkM3DTDLnAdBqWBBETpuJUZp&fallbackImgIpfs=Qmd9x81x4vSg7CptDqM8SPbhCRtGabEUWrWGKTAadn6dZc&fallbackUrl=https%3A%2F%2Fcrypto-catalyst.com"
            width="300"
            height="250"
            scrolling="no"
            frameBorder="0"
        ...
        p.text-xs-center Our Bread &amp; Butter
